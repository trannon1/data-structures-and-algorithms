...
const filterStringsWithVowels = (arr) => {
  ...
  let newArr = [];
  let regex = /[aeiou]/;
  return newArr = arr.filter(value => value.match(regex))
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newArr = [];
  return newArr = arr.filter(value => !forbiddenValues.includes(value))
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let newArr = [];
  return newArr = arr.filter(num => num.baseStat > minBaseStat)
};
...
const getStatName = (arr, minBaseStat) => {
  ...
  let newArr = [];
  let newArr2 = [];
  newArr = arr.filter(num => num.baseStat > minBaseStat)
  return newArr2 = newArr.map(value => value.stat.name);
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  let newArr = [];
  return newArr = arr.filter(person => !person.hasOwnProperty('children'))
};
...
const evenOddNumericValues = (arr) => {
  ...
  let newArr = [];
  let newArr2 = [];
  newArr = arr.filter(value => typeof value === 'number')
  return newArr2 = newArr.map(num => (num % 2 === 0)?'even':'odd')
};
